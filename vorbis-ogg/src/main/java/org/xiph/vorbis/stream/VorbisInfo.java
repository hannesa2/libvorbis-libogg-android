...
/**
 * A class used to pass org.xiph.vorbis file info to the encoder and find out what kind of file was received by the decoder.
 * 
 * Currently, the org.xiph.vorbis file encoder/decoder only supports 16-bit samples. There are no plans by me to ever add 8-bit. Defaults are set to whatever I
