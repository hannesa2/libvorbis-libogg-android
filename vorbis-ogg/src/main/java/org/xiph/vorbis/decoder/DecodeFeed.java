...
/**
 * A feed interface which raw PCM data will be written to and encoded org.xiph.vorbis data will be read from
 * User: vincent
 * Date: 3/27/13
 * Time: 2:11 PM
 */
public interface DecodeFeed {
    ...
    /**
     * The data is not a org.xiph.vorbis header
     */
    ...
    /**
     * Triggered from the native {@link VorbisDecoder} that is requesting to read the next bit of org.xiph.vorbis data
     *
     * @param buffer        the buffer to write to
     * @param amountToWrite the amount of org.xiph.vorbis data to write
     ...
     */
    public void start(org.xiph.vorbis.decoder.DecodeStreamInfo decodeStreamInfo);
}
