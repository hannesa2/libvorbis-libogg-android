...
/**
 * This feed is to be used by the native {@link VorbisEncoder} which will read raw pcm data and write encoded org.xiph.vorbis
 * data.
 * User: vincent
 * Date: 3/27/13
 * Time: 2:11 PM
...
public interface EncodeFeed {
    ...
    /**
     * Triggered by the native {@link VorbisEncoder} when encoded org.xiph.vorbis data is ready to be written
     *
     * @param vorbisData   the encoded org.xiph.vorbis data
     * @param amountToRead the amount of encoded org.xiph.vorbis data that can be read
