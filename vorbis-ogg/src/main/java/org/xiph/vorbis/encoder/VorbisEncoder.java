...
public class VorbisEncoder {
    /**
     * Load our org.xiph.vorbis-jni library as well as the other dependent libraries
     */
    static {
    ...
    /**
     * The native JNI method call to the encoder to start encoding raw pcm data to encoded org.xiph.vorbis data
     *
     * @param sampleRate       the sample rate which the incoming pcm data will arrive
     * @param numberOfChannels the number of channels
     * @param quality          the quality to encode the output org.xiph.vorbis data
     ...
     * @param sampleRate       the sample rate which the incoming pcm data will arrive
     * @param numberOfChannels the number of channels
     * @param bitrate          the bitrate of the output org.xiph.vorbis data
     * @param encodeFeed       the custom encoder feed
     */
